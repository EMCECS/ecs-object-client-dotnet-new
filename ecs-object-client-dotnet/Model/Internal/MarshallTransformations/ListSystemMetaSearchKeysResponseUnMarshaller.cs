...
{
    public class ListSystemMetaSearchKeysResponseUnMarshaller : S3ReponseUnmarshaller
    {
        ...
        private static ListSystemMetaSearchKeysResponseUnMarshaller _instance;

        public static ListSystemMetaSearchKeysResponseUnMarshaller Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new ListSystemMetaSearchKeysResponseUnMarshaller();
                }
                return _instance;
            }
        }
