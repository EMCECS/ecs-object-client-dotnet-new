...
{
    class QueryObjectsResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        private static QueryObjectsResponseUnmarshaller _instance;
        ...
        public static QueryObjectsResponseUnmarshaller Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new QueryObjectsResponseUnmarshaller();
                }
                return _instance;
            }
        }
